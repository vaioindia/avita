...
<div class="row">
    ...
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right">
            <br>
            <a class="btn btn-default" href="{{ route('exclusivebrand.index') }}" title="Go back"> <i class="fas fa-backward "></i> Back</a>
        </div>
    </div>
</div>
...
@endif
<form action="{{ route('exclusivebrand.store') }}" method="POST" enctype="multipart/form-data" >
    @csrf
