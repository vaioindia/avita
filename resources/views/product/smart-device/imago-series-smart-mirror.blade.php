...
<main class="top-nav-padding" style="background-color: #f0f0f0;">
    <div
       ...
       <div class="container">
          <div
             class="product-nav-toggler h2 text-center my-1 hidden-sm-up"> <i
             class="product-nav-icon fa fa-angle-up" aria-hidden="true"></i> </div>
          <div
             class="product-nav-collapse">
             <ul class="nav-product d-flex list-unstyled
                flex-column justify-content-center text-center flex-sm-row
                justify-content-sm-end py-2 mb-0">
                <li class="nav-item"><a class="nav-link
                   py-1" href="https://www.avita-india.com/product/imago">Overview</a></li>
                <li
                   class="nav-item"><a class="nav-link py-1"
                   href="https://www.avita-india.com/product/imago/spec">Tech Spec</a></li>
             </ul>
          </div>
       </div>
    </div>
