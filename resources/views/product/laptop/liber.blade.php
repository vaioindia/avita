...
<main class="top-nav-padding">
      ...
      <div class="container">
         ...
         <div class="product-nav-collapse">
            <ul class="nav-product d-flex list-unstyled flex-column justify-content-center text-center flex-sm-row justify-content-sm-end my-2">
               ...
               <li class="nav-item"><a class="nav-link py-1" href="https://www.avita-india.com/product/liber-new-generation">Overview 14"</a></li>
               <li class="nav-item"><a class="nav-link py-1" href="https://www.avita-india.com/product/liber/spec">Tech Spec</a></li>
   ...
   <section class="product-liber-banner">
      <div class="responsive-block">
         <div class="banner-block responsive-item">
            <div class="banner-bg hidden-sm-down" style="background-image: url('/assets/images/liber/liber_u_feature/banner.jpg')"></div>
            <div class="banner-bg hidden-md-up" style="background-image: url('/assets/images/liber/liber_u_feature/banner_mob.jpg')"></div>
   ...
   <section class="product-liber-computer ls-0" id="test">
      <div class="banner-block">
         ...
         <div class="banner-image">
            <img class="bc-computer-image bc-computer-1" src="{{ asset('assets/images/liber/liber_u_feature/sc2_fimg1.png') }}">
            <img class="bc-computer-image bc-computer-2" src="{{ asset('assets/images/liber/liber_u_feature/sc2_fimg2.png') }}">
            <img class="bc-computer-image bc-computer-3" src="{{ asset('assets/images/liber/liber_u_feature/sc2_fimg3.png') }}">
            <img class="bc-computer-image bc-computer-4" src="{{ asset('assets/images/liber/liber_u_feature/sc2_fimg4.png') }}">
            <img class="bc-computer-image bc-computer-5" src="{{ asset('assets/images/liber/liber_u_feature/sc2_fimg5.png') }}">
            <img class="bc-computer-image bc-computer-6" src="{{ asset('assets/images/liber/liber_u_feature/sc2_fimg6.png') }}">
         </div>
         <div class="container">
            <div class="banner-info">
               <div class="ac-computer-wrap">
                  <img class="ac-computer-image ac-computer-1" src="{{ asset('assets/images/liber/liber_u_feature/sc2_img1.png') }}">
                  <!-- <img class="ac-computer-image ac-computer-2" src="{{ asset('assets/images/liber/liber_u_feature/sc2_img2.png') }}"> -->
               </div>
   ...
   <section class="product-liber-size ls-0"/>
      <div class="banner-block">
         <div class="banner-bg"></div>
         <div class="banner-image">
            <img class="bc-computer-image bc-computer-1" src="{{ asset('assets/images/liber/liber_u_feature/sc3_fimg1.png') }}" style="right: 840px" >
            <img class="bc-computer-image bc-computer-2" src="{{ asset('assets/images/liber/liber_u_feature/sc3_fimg2.png') }}">
            <img class="bc-computer-image bc-computer-3" src="{{ asset('assets/images/liber/liber_u_feature/sc3_fimg3.png') }}">
            <img class="bc-computer-image bc-computer-4" src="{{ asset('assets/images/liber/liber_u_feature/sc3_fimg4.png') }}">
            <img class="bc-computer-image bc-computer-5" src="{{ asset('assets/images/liber/liber_u_feature/sc3_fimg5.png') }}">
            <img class="bc-computer-image bc-computer-6" src="{{ asset('assets/images/liber/liber_u_feature/sc3_fimg6.png') }}">
            <img class="bc-computer-image bc-computer-7" src="{{ asset('assets/images/liber/liber_u_feature/sc3_fimg7.png') }}">
            <img class="bc-computer-image bc-computer-8" src="{{ asset('assets/images/liber/liber_u_feature/sc3_fimg8.png') }}">
         </div>
         <div class="container">
            <div class="banner-info">
               <div class="h2 banner-header mb-4 mb-sm-5">Tangible Lightness</div>
               <div class="ac-computer-wrap hidden-md-up">
                  <img class="ac-computer-image ac-computer-1" style="" src="{{ asset('assets/images/liber/liber_u_feature/sc3_fimg2.png') }}">
               </div>
   ...
   <section class="product-liber-performance ls-0">
      <div class="banner-block">
         <div class="banner-bg"></div>
         <div class="banner-image">
            <img class="bc-computer-image bc-computer-1" src="{{ asset('assets/images/liber/liber_u_feature/sc4_fimg1.jpg') }}">
            <!-- <img class="bc-computer-image bc-computer-2" src="{{ asset('assets/images/liber/liber_u_feature/sc4_fimg2.png') }}"> -->
         </div>
         <div class="container">
            <div class="banner-info">
               <div class="ac-computer-wrap hidden-md-up">
                  <img class="ac-computer-image ac-computer-1" style="" src="{{ asset('assets/images/liber/liber_u_feature/sc4_fimg1.jpg') }}">
               </div>
   ...
   <section class="product-liber-power ls-0">
      ...
      <div class="banner-bg"></div>
      <div class="banner-image">
         <img class="bc-computer-image bc-computer-1" src="{{ asset('assets/images/liber/liber_u_feature/sc5_fimg1.jpg') }}">
      </div>
      <div class="container">
            ...
            <div class="col-12 col-lg-5">
               <div class="banner-info  mx-auto">
                  <div class="h2 banner-header mb-4 mb-sm-5">
                     <div class="d-sm-inline">Full Battery for All-day Menu</div>
                  </div>
                  <div class="banner-para ls-0">
               ...
               <!-- <img class="ac-computer-image ac-computer-1" src="{{ asset('assets/images/liber/liber_u_feature/sc5_fimg1.jpg') }}"> -->
            </div>
   ...
   <section class="product-liber-keyboard ls-0">
      <div class="banner-block">
         <div class="banner-bg"></div>
         <div class="banner-image">
            <img class="bc-computer-image bc-computer-1" src="{{ asset('assets/images/liber/liber_u_feature/sc6_fimg1.png') }}">
         </div>
         <div class="container">
            <div class="banner-info mx-auto ml-lg-0">
               <div class="h2 banner-header mb-4 mb-sm-5">Pleasing Keyboard Design</div>
               <div class="ac-computer-wrap hidden-md-up">
                  <img class="ac-computer-image ac-computer-1" style="" src="{{ asset('assets/images/liber/liber_u_feature/sc6_fimg1.png') }}">
               </div>
               <div class="banner-para ls-0">
   ...
   <section class="product-liber-port ls-0">
      <div class="banner-block">
         <div class="banner-bg"></div>
         <div class="banner-image">
            <img class="bc-computer-image bc-computer-1" src="{{ asset('assets/images/liber/liber_u_feature/sc7_fimg1.png') }}">
            <img class="bc-computer-image bc-computer-2" src="{{ asset('assets/images/liber/liber_u_feature/sc7_fimg2.png') }}">
            <img class="bc-computer-image bc-computer-3" src="{{ asset('assets/images/liber/liber_u_feature/sc7_fimg3.png') }}">
         </div>
         <div class="container">
            <div class="banner-info mx-auto mr-lg-0">
               <div class="ac-computer-wrap hidden-md-up">
                  <img class="ac-computer-image ac-computer-1" style="" src="{{ asset('assets/images/liber/liber_u_feature/sc7_fimg1.png') }}">
               </div>
   ...
   <section class="product-liber-performance2 ls-0">
      <div class="banner-block">
         <div class="banner-bg"></div>
         <div class="banner-image">
            <img class="bc-computer-image bc-computer-1" src="{{ asset('assets/images/liber/liber_u_feature/sc8_fimg1.png') }}">
            <!-- <img class="bc-computer-image bc-computer-2" src="{{ asset('assets/images/liber/liber_u_feature/sc8_fimg2.png') }}"> -->
            <img class="bc-computer-image bc-computer-3" src="{{ asset('assets/images/liber/liber_u_feature/sc8_fimg3.png') }}">
            <img class="bc-computer-image bc-computer-4" src="{{ asset('assets/images/liber/liber_u_feature/sc8_fimg4.png') }}">
            <img class="bc-computer-image bc-computer-5" src="{{ asset('assets/images/liber/liber_u_feature/sc8_fimg5.png') }}">
            <img class="bc-computer-image bc-computer-6" src="{{ asset('assets/images/liber/liber_u_feature/sc8_fimg6.png') }}">
            <img class="bc-computer-image bc-computer-7" src="{{ asset('assets/images/liber/liber_u_feature/sc8_fimg7.png') }}">
            <img class="bc-computer-image bc-computer-8" src="{{ asset('assets/images/liber/liber_u_feature/sc8_fimg8.png') }}">
         </div>
         <div class="container">
            <div class="banner-info mx-auto ml-lg-0">
               <div class="ac-computer-wrap hidden-md-up">
                  <img class="ac-computer-image ac-computer-1" style="" src=""{{ asset('assets/images/liber/liber_u_feature/sc8_fimg2.png') }}">
               </div>
               ...
               <div class="banner-data-inner ls-0">
                  <div class="banner-data d-flex flex-wrap justify-content-center justify-content-sm-between align-items-center">
                     <div class="data-card col-12 col-sm-3 my-2 my-sm-0">
                        <div class="badge-image"><img src="{{ asset('assets/images/liber/liber_u_feature/sc8_img1.png') }}"></div>
                     </div>
                     <!---
                     ...
                     <div class="data-card col-12 col-sm-3 my-2 my-sm-3">
                        <div class="badge-image"><img src="{{ asset('assets/images/liber/liber12_feature/sc8_img2.png') }}"></div>
                     </div>
                     <div class="data-card col-6 col-sm-4 my-2 my-sm-3">
                  ...
                  <!-- <div class="banner-data d-flex flex-wrap justify-content-between align-items-center pt-3 pt-md-4">
                     <div class="data-card col-12 col-sm-3 my-2 my-sm-0">
                         <div class="badge-image"><img src="assets/images/liber/liber_u_feature/sc8_img2.png"></div>
                     </div>
   ...
   <section class="product-liber-wifi ls-0">
      <div class="banner-block">
         <div class="banner-bg"></div>
         <div class="banner-image">
            <img class="bc-computer-image bc-computer-1" src="{{ asset('assets/images/liber/liber_u_feature/sc9_fimg1.png') }}">
            <img class="bc-computer-image bc-computer-2" src="{{ asset('assets/images/liber/liber_u_feature/sc9_fimg2.png') }}">
         </div>
         <div class="container">
      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-sm-6">
                  <br/>
                  <br/>
                  <img class="bc-computer-image bc-computer-2" src="assets/images/liber/avita_sleeves.png" style="width: 512px; height: 300px; ">
              </div>
              <div class="col-sm-3">
              </div>
          </div>
